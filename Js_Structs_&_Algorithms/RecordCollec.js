...
function updateRecords(records, id, prop, value) {
    var pexist = records[id].hasOwnProperty(prop);
    var vexist = records.hasOwnProperty(value);
   
    if (pexist == false){records[id][prop] = records[id].push(prop) ;}
    if (vexist == false){ records[id][prop] = records[id][prop].push(value);}
